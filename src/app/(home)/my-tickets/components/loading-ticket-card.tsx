    ...
    <div className="ticket-card flex justify-between items-center rounded-[20px] p-5 bg-flysha-bg-purple">
      <div className="flex gap-[16px] items-center">
        <div className="flex shrink-0 w-[90px] h-[70px] rounded-[14px] overflow-hidden">
          <Skeleton className="bg-gray-400 w-[90px] h-[70px] rounded-md" />
        </div>
        <div className="flex flex-col justify-center-center gap-[2px]">
          <Skeleton className="bg-gray-400 w-[60px] h-5 " />
          <Skeleton className="bg-gray-400 w-[90px] h-5 " />
        </div>
      </div>
      <Skeleton className="bg-gray-400 w-[120px] h-5 " />
      ...
      <Skeleton className="bg-gray-400 w-[97px] h-[48px] rounded-full" />
    </div>
  );
}
